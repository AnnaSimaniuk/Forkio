...
export const windowLoad = () => {
    const digitsCounterInit = digitsCountersItems => {
        let digitsCounters = digitsCountersItems ? digitsCountersItems : document.querySelectorAll('[data-digits-coutter]')
    ...
    let observer = new IntersectionObserver((entries, observer) => {
        entries.forEach(entry => {
            if (entry.isIntersecting) {
                ...
                const digitsCountersItems = targetElement.querySelectorAll('[data-digits-coutter]')
